...
const { createProductRoute, getAllProductsRoute, updateProductRoute, deleteProductRoute , productStats} = require('./productRoutes');
...
app.get('/product-statistics', productStats);
